...
setup(
    ...
    executables=[Executable(script="raven_framework.py",icon="icons/raven_64.ico"),
                 Executable(script="heron.py",icon="icons/heron_64.ico"),
                 Executable(script="teal.py",icon="icons/teal_64.ico")],
