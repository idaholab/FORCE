...
def get_baseline_NPV(case):
  ...
  if ('ptc' in case_list) or ('om' in case_list) or ('elec' in case_list) or ('capex' in case_list) or ('synfuels' in case_list) or ('co2' in case_list):
